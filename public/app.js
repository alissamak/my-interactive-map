...
async function userCoord(){
    ...
    async function getBusiness(business, lat, lng){
        lat = location.coords.latitude
        lng = location.coords.longitude
        ...
        //fetching data with dyanmic link based on business, lat, and lng
        let response = await fetch(`https://api.foursquare.com/v3/places/search?query=${business}&ll=${lat}%2C${lng}&limit=10`, options)     
        ...
        businesses.forEach(business => {
            ...
            let businessLng = business.geocodes.main.longitude;
